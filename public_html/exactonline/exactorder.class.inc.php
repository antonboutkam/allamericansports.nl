<?php
class ExactOrder extends ExactBase{
...
*/            
            ...
            $xml[] = '                <NetPrice>';
            $xml[] = '                    <Currency code="EUR" />';
            $xml[] = '                    <Value>'.(round(($totals/($vat*100))*100,2)).'</Value>';
            $xml[] = '                    <VAT code="4">';
...
*/            
        ...
        $xml[] = '                <NetPrice>';
        $xml[] = '                    <Currency code="EUR" />';
        $xml[] = '                    <Value>'.round(($item['send_cost']*$vat),2).'</Value>';
        $xml[] = '                    <VAT code="4">';
        $xml[] = '                        <Description>BTW hoog tarief, inclusief</Description>';
        $xml[] = '                    </VAT>';
        $xml[] = '                    <VATPercentage>0.'.$vat_perc.'</VATPercentage>';
        ...
        // windows line ending   
		#exit(join("\r\n",$xml));
        mail('anton@nui-boutkam.nl','Order XML',join("\r\n",$xml));
