...
class Paypal {
   ...
   function validate_ipn() {
      Log::message('payment',"Callback to paypal for payment validation",__METHOD__);
      ...
      if(!$fp) {
         ...
         // will be in the log.
         Log::message('payment',"fsockopen error no. $errnum: $errstr",__METHOD__);
      ...
      Log::message('ipnlog',$this->ipn_response,__METHOD__);
      if (preg_match("/VERIFIED/i",$this->ipn_response)) {
        Log::message('payment',"payment ok",__METHOD__);
         // Valid IPN transaction.
         $this->log_ipn_results(true);
         return true;       
         
      } else {
        Log::message('payment',"payment not ok",__METHOD__);
   ...
   function log_ipn_results($success) {
      ...
      Log::message('ipnlog',$this->ipn_log_file,__METHOD__);
   }
