...
class Multipart {
	...
	public function __construct($file="",$disposition="attachment",$fileType) {
		if ($file != "")
			$this->setContent($file, $disposition,$fileType);
	}
	 ...
	 * @return	boolean
	 */
	public function setContent($file, $disposition = "attachment",$fileType) {
