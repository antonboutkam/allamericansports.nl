...
$sql = "UPDATE `calendar_afspraken` SET `deleted`='1' WHERE `id`='".$_GET['id']."'";
...
<?php
	...
	echo '<div class="text">';
	echo '<b>Weet je zeker dat je deze afspraak wilt verwijderen?</b><p />';	
	echo '<a href="delete.php?ct='.$_GET['ct'].'&tijd='.$_GET['time'].'&id='.$_GET['id'].'&ok=1">Ja, bevestig</a><p /> ';
