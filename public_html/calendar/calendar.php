...
{
	if($row['6u']==1 || $row['7u']==1 || $row['8u']==1 || $row['9u']==1 || $row['10u']==1 || $row['11u']==1 || $row['12u']==1 || $row['13u']==1 || $row['14u']==1 || $row['15u']==1 || $row['16u']==1 || $row['17u']==1 || $row['18u']==1 || $row['19u']==1 || $row['20u']==1 || $row['21u']==1 || $row['22u']==1){
$count++;
	}
}
		$datetargets="".$year."-".$month."-".$cur."";
		
	if(strtotime($datetargets) > time() && $count>0 && ($i <= ($days+($start-1)) && $i >= $start)){
