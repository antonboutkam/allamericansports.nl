...
if($_GET['do']%17==1){
	...
	while($rowx = mysql_fetch_array($resultx))
	{
		...
		mysql_query($querys)or die('Error.');
		
		$queryw = "DELETE FROM `calendar_afspraken` WHERE id=$id";
		mysql_query($queryw)or die('Error.');
	...
	echo '<div class="text">Uw afspraak is geannuleerd. <p /> <a href="http://www.allamericangymnastics.nl/calendar">Klik hier om direct een nieuwe afspraak te maken.</a></div><p />';
	echo '<div class="text">Your visit has been canceled. <p /> <a href="http://www.allamericangymnastics.nl/calendar">Click here for planning a new visit.</a></div>';
}
elseif($_GET['do']%17==2){
	echo '<div class="text">Uw afspraak staat nog steeds gepland en is niet geannuleerd.<p /> <a href=\"http://www.allamericanbaseball.nl/calendar\">Naar de startpagina van het afspraaksysteem</a><p /> <a href=\"http://www.allamericansports.nl\">Naar de All-American Sports website</a></div><p />';
	echo '<div class="text">Your visit has not been canceled<p /> <a href=\"http://www.allamericanbaseball.nl/calendar\">To the homepage</a><p /> <a href=\"http://www.allamericansports.nl\">To the All-American Sports website</a></div>';
}
else{
...
if($_GET['t']==$timedatabase && $_GET['q']%$id==1 && $row['check']==1){
	?>
